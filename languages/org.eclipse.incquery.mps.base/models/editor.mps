...
<model ref="r:6ff18591-3edc-4f8c-b3b1-e47cd5e8edd2(org.eclipse.incquery.mps.base.editor)">
  ...
  <node concept="24kQdi" id="3VwoHXNC1YJ">
    <property role="3GE5qa" value="content" />
    <ref role="1XX52x" to="hqsm:3hiszdZDhip" resolve="EmptyContent" />
    <node concept="3F0ifn" id="3VwoHXNC1YL" role="2wV5jI">
      <node concept="VPxyj" id="5xy6TextmR7" role="3F10Kt">
  ...
  <node concept="24kQdi" id="RjyNapPtKy">
    <property role="3GE5qa" value="values" />
    <ref role="1XX52x" to="hqsm:RjyNapPtIh" resolve="VariableValue" />
    <node concept="3F1sOY" id="RjyNapPtK$" role="2wV5jI">
      <ref role="1NtTu8" to="hqsm:RjyNapPtK9" />
    </node>
  </node>
  ...
  <node concept="24kQdi" id="EE49sS1D2H">
    <property role="3GE5qa" value="values" />
    <ref role="1XX52x" to="hqsm:EE49sS1D0i" resolve="TemporaryVariableValue" />
    <node concept="3F1sOY" id="EE49sS4uAw" role="2wV5jI">
      <ref role="1NtTu8" to="hqsm:EE49sS1D0j" />
    </node>
  </node>
  ...
  <node concept="24kQdi" id="4$7kDlU0lLT">
    <ref role="1XX52x" to="hqsm:3VwoHXNAdmj" resolve="IPatternModel" />
