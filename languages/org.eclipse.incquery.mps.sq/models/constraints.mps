...
<model ref="r:553b9935-c0fe-4e2d-b86a-d1bbff07fc95(org.eclipse.incquery.mps.sq.constraints)">
                        ...
                        <node concept="2YIFZM" id="KHoiwD2pEl" role="37vLTx">
                          ...
                          <node concept="2OqwBi" id="KHoiwD2pEn" role="37wK5m">
                            ...
                            <node concept="2qgKlT" id="KHoiwD2pEr" role="2OqNvi">
                              <ref role="37wK5l" to="coho:Tz5AFeEMOV" resolve="compatibleWith" />
                            </node>
                          </node>
                        </node>
                      </node>
  ...
  <node concept="1M2fIO" id="1fSpEsnLW5p">
    <property role="3GE5qa" value="constraints" />
    <ref role="1M2myG" to="ebqt:Tz5AFeK9Ac" resolve="SConceptExpression" />
    <node concept="1N5Pfh" id="1fSpEsnLW5q" role="1Mr941">
      <ref role="1N5Vy1" to="ebqt:Tz5AFeK9Am" />
    </node>
  </node>
  <node concept="1M2fIO" id="4IZiQsKumNJ">
    <property role="3GE5qa" value="misc" />
    <ref role="1M2myG" to="ebqt:4IZiQsKumNF" resolve="SParameter" />
